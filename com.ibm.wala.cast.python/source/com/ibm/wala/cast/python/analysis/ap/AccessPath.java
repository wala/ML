...
public class AccessPath {
  ...
  public static IAccessPath appendUnknown(LocalAP ap) {
    return ListAP.createListAP(ap, Collections.<IPathElement> singletonList(UnknownPathElement.singleton()));
  }
  ...
  public static IAccessPath arrayAccess(int arrayValueNumber) {
    return append(localAP(arrayValueNumber), Collections.<IPathElement> singletonList(ArrayContents.singleton()));
  }
  
  public static IAccessPath fieldAccess(int refValueNumber, String field) {
    return append(localAP(refValueNumber), Collections.<IPathElement> singletonList(PropertyPathElement.createFieldPathElement(field)));
  }

  public static IAccessPath methodAccess(int refValueNumber, String method) {
    return append(localAP(refValueNumber), Collections.<IPathElement> singletonList(PropertyPathElement.createMethodPathElement(method, null)));
  }
