...
public class DiagnosticsFormatter {
  ...
  public static void displayTextRange(
      String pre, PrintStream out, String uri, String[] lines, Range range) {
    ...
    pretty {
      ...
      public void print(
        ...
        for (Map.Entry<String, String> kv : texts.entrySet()) {
          lines.put(
              kv.getKey(),
              new BufferedReader(new StringReader(kv.getValue())).lines().toArray(String[]::new));
        }
  ...
  public static Map<String, List<Diagnostic>> filterSeverity(
      Map<String, List<Diagnostic>> diagnostics, Set<DiagnosticSeverity> severityList) {
