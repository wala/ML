...
public class PropertyPathElement implements IPathElement {
  ...
  public static PropertyPathElement createMethodPathElement(String field, final Set<Integer> interestingParameters) {
  ...
  public static IPathElement createCallbackPathElement(String field, final Set<Pair<Integer, List<String>>> callbackParameters, final Set<Pair<Integer, List<String>>> callbackTaintedParams) {
  ...
  public boolean matches(IPathElement other) {
   return this.equals(other) || other instanceof UnknownPathElement || other instanceof StarPathElement;
  }
