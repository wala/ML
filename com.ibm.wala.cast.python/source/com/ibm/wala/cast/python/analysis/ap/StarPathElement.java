...
/**
 * A path element representing all possible sequences of fields. This should
 * only appear as the final element of an access path.
 * 
 */
public class StarPathElement implements IPathElement {
  
  private final static StarPathElement instance = new StarPathElement();
