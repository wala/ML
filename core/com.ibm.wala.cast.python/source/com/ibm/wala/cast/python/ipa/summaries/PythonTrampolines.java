...
public abstract class PythonTrampolines implements MethodTargetSelector {
	...
	abstract PythonSummarizedFunction makeTrampoline(CGNode caller, CallSiteReference site, IClass receiver, MethodReference method);
	...
	public IMethod getCalleeTarget(CGNode caller, CallSiteReference site, IClass receiver) {
	    ...
	    if (method.getSelector().equals(AstMethodReference.fnSelector)
	        && caller
	            .getClassHierarchy()
	            .isSubclassOf(
	                receiver, caller.getClassHierarchy().lookupClass(specializedType()))
