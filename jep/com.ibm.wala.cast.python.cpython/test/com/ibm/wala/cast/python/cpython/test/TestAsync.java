...
public class TestAsync extends TestJythonCallGraphShape {
  ...
  protected static final Object[][] assertionsAsync1 =
      new Object[][] {
        new Object[] {ROOT, new String[] {"script async1.py"}},
        new Object[] {
          "script async1.py", new String[] {"CodeBody:$coroutine$Lscript async1.py/fibonacci"}
        },
        new Object[] {
          "CodeBody:$coroutine$Lscript async1.py/fibonacci",
          new String[] {"script async1.py/fibonacci"}
        },
        new Object[] {
          "script async1.py/fibonacci",
  ...
  protected static final Object[][] assertionsAsync2 =
      new Object[][] {
        new Object[] {ROOT, new String[] {"script async2.py"}},
        new Object[] {
          "script async2.py", new String[] {"CodeBody:$coroutine$Lscript async2.py/fibonacci"}
        },
        new Object[] {
          "CodeBody:$coroutine$Lscript async2.py/fibonacci",
          new String[] {"script async2.py/fibonacci"}
        },
        new Object[] {
          "script async2.py/fibonacci",
          new String[] {
            "CodeBody:$coroutine$Lscript async2.py/fibonacci",
  ...
  protected static final Object[][] assertionsAsync3 =
      new Object[][] {
        new Object[] {ROOT, new String[] {"script async3.py"}},
        new Object[] {
          "script async3.py",
          new String[] {
            "CodeBody:$coroutine$Lscript async3.py/fibonacci",
            "asyncio/class/run",
  ...
  protected static final Object[][] assertionsAsync4 =
      new Object[][] {
        new Object[] {ROOT, new String[] {"script async4.py"}},
        new Object[] {
          "script async4.py",
          new String[] {"asyncio/class/run", "CodeBody:$coroutine$Lscript async4.py/main"}
        },
        new Object[] {
          "CodeBody:$coroutine$Lscript async4.py/main", new String[] {"script async4.py/main"}
        },
        new Object[] {
          "script async4.py/main",
          new String[] {
        ...
        new Object[] {
          "CodeBody:$coroutine$Lscript async4.py/gen", new String[] {"script async4.py/gen"}
        },
      };
  ...
  protected static final Object[][] assertionsAsync5 =
      new Object[][] {
        new Object[] {ROOT, new String[] {"script async5.py"}},
        new Object[] {
          "script async5.py",
          new String[] {"asyncio/class/run", "CodeBody:$coroutine$Lscript async5.py/main"}
        },
        new Object[] {
          "CodeBody:$coroutine$Lscript async5.py/main", new String[] {"script async5.py/main"}
        },
        new Object[] {
          "script async5.py/main",
          new String[] {
