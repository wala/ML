...
public class TestGenerators extends TestJythonCallGraphShape {
      ...
      new Object[][] {
        ...
        new Object[] {
          ...
          new String[] {
            ...
            "script gen1.py/f2/lambda2",
            "script gen1.py/f3/lambda3",
            "script gen1.py/f1",
            "script gen1.py/f2",
            "script gen1.py/f3"
          }
      ...
      new Object[][] {
        ...
        new Object[] {
          ...
          new String[] {
            ...
            "script gen2.py/f2/lambda2",
            "script gen2.py/f3/lambda3",
            "script gen2.py/f1",
            "script gen2.py/f2",
            "script gen2.py/f3",
            "script gen2.py/gen"
  ...
  protected static final Object[][] assertionsForGen3 =
      new Object[][] {
        ...
        new Object[] {
          "script gen3.py",
          new String[] {
            "script gen3.py/f1/lambda1",
            "script gen3.py/f2/lambda2",
            "script gen3.py/f3/lambda3",
  ...
  protected static final Object[][] assertionsForGen4 =
      new Object[][] {
        ...
        new Object[] {"script gen4.py/gen", new String[] {"script gen4.py/gen1"}},
        new Object[] {
          "script gen4.py",
          new String[] {
            "script gen4.py/f1/lambda1",
            "script gen4.py/f2/lambda2",
            "script gen4.py/f3/lambda3",
            "script gen4.py/f1",
            "script gen4.py/f2",
            "script gen4.py/f3",
            "script gen4.py/gen"
  ...
  protected static final Object[][] assertionsForGen5 =
      new Object[][] {
        ...
        new Object[] {"script gen5.py/gen", new String[] {"script gen5.py/gen1"}},
        new Object[] {
          "script gen5.py",
        ...
        new Object[] {
          "script gen5.py/p2",
          new String[] {
            "script gen5.py/f1/lambda1",
            "script gen5.py/f2/lambda2",
            "script gen5.py/f3/lambda3",
            "!script gen5.py/f1",
            "!script gen5.py/f2",
            "!script gen5.py/f3",
            "!script gen5.py/gen"
