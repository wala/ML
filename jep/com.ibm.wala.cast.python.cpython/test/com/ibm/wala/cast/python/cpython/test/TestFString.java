...
public class TestFString extends TestJythonCallGraphShape {
	  ...
	  protected static final Object[][] assertionsForFString1 =
		      new Object[][] {
		        ...
		        new Object[] {
		          "script f-strings1.py",
		          new String[] {
		            "script f-strings1.py/g", "script f-strings1.py/f"}
		        },
		        new Object[] {
				  "script f-strings1.py/g",
				  new String[] {
				    "script f-strings1.py/f"}
		        }
	  };

	@Test
	public void testFString1() throws ClassHierarchyException, IllegalArgumentException, CancelException, IOException {
	  ...
	  protected static final Object[][] assertionsForFString2 =
		      new Object[][] {
		        ...
		        new Object[] {
				  ...
				  new String[] {
				    "script f-strings2.py/g",
				    "script f-strings2.py/f"}
		        }
	  };

	@Test
	public void testFString2() throws ClassHierarchyException, IllegalArgumentException, CancelException, IOException {
