...
public class TestWalrus extends TestJythonCallGraphShape {
  ...
  protected static final Object[][] assertionsWalrus1 =
      new Object[][] {
        ...
        new Object[] {"script walrus1.py/g", new String[] {"script walrus1.py/Foo"}},
        new Object[] {"script walrus1.py/Foo", new String[] {"script walrus1.py/Foo/__init__"}},
        new Object[] {
          "$script walrus1.py/Foo/f:trampoline2", new String[] {"script walrus1.py/Foo/f"}
        },
        new Object[] {
          "$script walrus1.py/Foo/h:trampoline2", new String[] {"script walrus1.py/Foo/h"}
        }
      };

  @Test
  public void testWalrus1()
